# M4 Keycap Generator -- manual Bambu Studio verification (revision 22)
...
Bounding box: 18.500 x 18.500 x 10.000 mm.
Triangles: 592. Watertight: true.

### keycap_legend_wrap_center.stl ("VIET ANH", emboss, align=center -- the default)
Auto-wraps to 2 lines ("VIET" / "ANH"), each centered.
Bounding box: 18.500 x 18.500 x 10.600 mm.
Triangles: 4792. Watertight: true.
